...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Animated, TextInput, Image } from 'react-native'
                    ...
                    >
                        ...
                        <View style={styles.toggleBackground}>
                            ...
                            >
                                <Text style={[
                                    styles.toggleText,
                                    type === 'home' && styles.activeToggleText
                                ]}>ホーム</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={styles.toggleTouchable}
                            ...
                            >
                                <Text style={[
                                    styles.toggleText,
                                    type === 'search' && styles.activeToggleText
                                ]}>探す</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
